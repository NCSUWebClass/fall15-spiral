...
var mini1; //mini monster 1 sprite
var mini2;
var mini3;
var monster;
var monster2;
...
{x:791,y:97,w:43,h:16},
{x:826,y:106,w:31,h:110},
...
{x:20,y:923,w:38,h:26},
{x:39,y:853,w:21,h:13},
...
var monsterPos = {x:168, y:440};
var monsterDir = true; //true for right, false for left
var monsterFrame = 1; //1-200 to trak monster animation

var monster2Pos = {x:590, y:700};
var monster2Dir = true; //true for right, false for left
var monster2Frame = 1; //1-200 to trak monster animation
...
function draw(){
    ...
    if(monsterDir){
      if(monster2Frame == 54){
        ...
        monster2.position.x += monsterSpeed;
        monster2Frame++;
      }
    }else{
      if(monster2Frame == 54){
        monster2.rotation = 180;
        monster2Frame = 1; 
        monster2Dir = true;
      }else{
        monster2.position.x -= monsterSpeed;
    ...
    if(playing && (character.position.x > bgsize.x || character.position.y > bgsize.y || character.position.x < 0 || character.position.y < 0 || character.overlap(mini1) || character.overlap(mini2) || character.overlap(mini3) || character.overlap(monster) || character.overlap(monster2))){
...
function setup() {
  ...
  miniImg1 = loadImage("./assets/Mini1_Final.png");
  miniImg2 = loadImage("./assets/Mini2_Final.png");
  miniImg3 = loadImage("./assets/Mini3_Final.png");
  ...
  mini1 = createSprite(miniMonsterPos[0].x, miniMonsterPos[0].y);
  mini2 = createSprite(miniMonsterPos[1].x, miniMonsterPos[1].y);
  mini3 = createSprite(miniMonsterPos[2].x, miniMonsterPos[2].y);
  monster = createSprite(monsterPos.x, monsterPos.y);
  monster2 = createSprite(monster2Pos.x, monster2Pos.y);

  mini1.addImage(miniImg1);
  mini2.addImage(miniImg3);
  mini3.addImage(miniImg2);


  character.addAnimation("walking","./assets/WC01.png","./assets/WC09.png");
  monster.addAnimation("moving","./assets/monster_WC1.png","./assets/monster_WC3.png");
  monster2.addAnimation("moving","./assets/monster_WC1.png","./assets/monster_WC3.png");
